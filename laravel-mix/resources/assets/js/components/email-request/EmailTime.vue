<template>
   <div class="email-time" :class="{
      ...
      <div class="email-time__add">
         <button class="button button-default" :disabled="schedule_email_customs_prop && schedule_email_customs_prop.length >= 9" @click="addEmailTime()">+ Set next email</button>
      </div>
      <div class="email-time__content" @click="selectIndexEmailTime()">
         <div class="email-time__body">
            <span class="mr-10 ml-20 fw700 fz15">Wait</span>
