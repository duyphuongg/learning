...
export const getParams = (method = 'GET', url = '', data = null, headers = {}) => {
    let headerDefault = {
...
export const request = (method = 'GET', url, body, header) => {
    let options = getParams(method, url, body, header);
