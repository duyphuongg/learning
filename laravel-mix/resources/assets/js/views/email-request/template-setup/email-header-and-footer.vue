            ...
            <div class="col-md-6 email-header-and-footer__form">
                <div class="mb-20">
                    <div class="d-flex justify-content-between mt-5 mb-5">
                        <label class="fz15 color-dark-blue fw700">Shop Name</label>
                        <small v-show="is_schedule_new_email_prop && errors.has('form-1.shop_name')" class="field-text is-danger mt-10 fw500">{{ errors.first('form-1.shop_name') }}</small>
                    </div>
                    <input v-validate="'required'" type="text" class="form-control" :class="{ 'is-danger': is_schedule_new_email_prop && errors.has('form-1.shop_name') }" name="shop_name" placeholder="Write your shop name" v-model="email_settings.shop_name">
                </div>

                <div class="mb-20">
                    <div class="d-flex justify-content-between mt-5 mb-5 shop-email">
                        <label class="fz15 color-dark-blue fw700">Shop Email</label>
                        <div class="d-flex">
                            <small v-show="is_schedule_new_email_prop && errors.has('form-1.shop_email')" class="field-text is-danger mt-10 mr-10 fw500">{{ errors.first('form-1.shop_email') }}</small>
                    ...
                    <input v-validate="'required|email'" type="text" class="form-control" :class="{ 'is-danger': is_schedule_new_email_prop && errors.has('form-1.shop_email') }" placeholder="example@gmail.com" name="shop_email" v-model="email_settings.shop_email">
                </div>
                <div>
