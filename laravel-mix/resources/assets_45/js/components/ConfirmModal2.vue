            ...
            <div class="modal-wrapper">
                <div class="modal-container" :class="modal_class_prop">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close btn-close" @click="onClose" >
                            <i class="material-icons">close</i>
                        </button>
                    </div>
                    <div class="modal-footer text-center">
                        <button type="button" class="button button--default w-135px mar-r-5" @click="onConfirm(false)">{{btn_cancel}}</button>
                        <button type="button" class="button button--primary button--orange w-135px mar-l-5" :class="btn_ok_class_prop" @click="onConfirm(true)">{{btn_ok}}</button>
                    </div>
                </div>
            </div>
        </div>
