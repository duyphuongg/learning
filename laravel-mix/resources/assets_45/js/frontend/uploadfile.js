...
fileUploader.prototype.PreviewThumbnail = function() {
  ...
  //drop image
  const targetDrop = document.getElementById('alireview_file_upload_target');
  targetDrop.addEventListener('dragover', (e) => {
    targetDrop.classList.add('dragging');
    e.preventDefault();
  });

  targetDrop.addEventListener('dragleave', (e) => {
    e.preventDefault();
    targetDrop.classList.remove('dragging');
  });
