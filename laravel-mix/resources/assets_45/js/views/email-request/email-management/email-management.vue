    ...
    <div class="email-management">
        ...
        <div class="wrapper-space email-dashboard-page">
            ...
            <div class="emails-welcome text-center" v-if="schedule_new_email === false">
                ...
                <h2 class="mb-30">After-sales emails bring more sales</h2>
                <p class="mb-30 color-dark-blue">
                    Ask your customers for product reviews and reward them with discount coupons.<br>
                    Go to <strong>Email Settings</strong> and create your email campaign now.
                </p>
                <a class="btn btn-primary btn--orange" v-bind:href="route_setting_template">Create Email Campaign</a>
            </div>

            <div class="" v-if="schedule_new_email === true">
                <h4 class="media-heading fz18 fw-bold color-dark-blue mar-b-20">Email History</h4>
                <email-status
                ...
                <div class="wapper-tbl-action-2 mt-20 mb-30 d-flex" style="align-items: flex-end;">
                                    ...
                                    <span class="rel-tooltip email__tooltip__send-date">
                                        ...
                                        <div class="tooltip fade">
                                            <div class="tooltip-inner">
                                                <p>
                                                    When you schedule emails, we'll use this time zone (GMT-5:00) Eastern Time (US & Canada) as default.
                                                </p>
                                            </div>
                                        </div>
                                    </span>
                    ...
                    <div v-else v-show="on_load == false">
                        <p class="empty-space mt-40"><i class="material-icons">speaker_notes_off</i> <br>
                            <span class="mar-b-25">
                                ...
                                <span v-else>
                                    <span v-if="filters.status=='pending'">No pending emails found</span>
                                <span v-if="filters.status=='finished'">No emails sent</span>
...
<script>
    ...
    export default {
        ...
        computed: {
            pre_page(){
                return (this.pagination.prev_page_url) ? (this.pagination.current_page - 1) : null
            },
            next_page(){
                return (this.pagination.next_page_url) ? (this.pagination.current_page + 1) : null
            }
        },
        created: function () {
            this.onCheckWelcome();
...
//                console.log(event.target.value);
            ...
            paginationEmails: function (page) {
            ...
            onChoosePage : function(page){
                this.paginationEmails(page)
            }
        }
    }
</script>