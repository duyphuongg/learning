<template>
    <div class="modal fade ali-modal ali-modal--noline" id="modalStop" tabindex="-1" role="dialog"
         aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content text-center">
                <div class="modal-body pad-0">
                    <div class="modal-body__content fw600 fz13">
                        <p class="note fw600 mar-b-35">Are you sure to stop this mail from sending queue?</p>
                    </div>
                </div>
                <div class="modal-footer text-center">
                    <form v-on:submit.prevent="onSubmitForm($event)">
                        ...
                        <button type="submit" class="button button--primary w-105px mar-l-5">Stop now</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    import {stopEmail} from '../../../services/EmailRequestService';
    ...
    export default {
        ...
        methods: {
            onSubmitForm: function (event) {
                ...
                stopEmail(this.data_modal.emailId).then(res => {
