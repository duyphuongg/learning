    ...
    <div class="row email-custom">
        <div class="col-md-6">
            <div class="mb-30 mt-10 d-flex justify-content-between">
                <div class="dropdown add-new-email__dropdown" v-if="email_custom.length < 9">
                    ...
                    <ul class="dropdown-menu">
                        <li><a @click="addEmailCustom(1)">Discount code</a></li>
                        <li><a @click="addEmailCustom(2)">Referral code</a></li>
                        <li><a @click="addEmailCustom(3)">Free shipping code</a></li>
                        <li><a @click="addEmailCustom(4)">Blank email</a></li>
                    </ul>
                </div>
            </div>
            <div class="email-custom__list" v-if="email_custom.length > 0">
                <div class="email-custom__item"
                     ...
                     :class="{
                            ...
                            'email-custom__item-valid': (!valid_email_tab_3_prop[index].is_valid || !valid_email_tab_3_prop[index].unique_title)
                      }"
                ...
                >
                    <div
                            ...
                            :class="{'email-custom__item-title__valid': !valid_email_tab_3_prop[index].unique_title}"
                    >
            ...
            <div class="email-custom__list" v-else>
                <div class="email-custom__item email-disabled" v-if="email_custom_setting_default">
        ...
        watch: {
            ...
            listen_reset_tab_3_prop: {
                handler: function (val, oldVal) {
                    ...
                    this.email_custom_preview = this.email_custom.length > 0 ? this.email_custom[0] : this.email_custom_setting_default;
                },
                deep: true
            }
        },
